...
device = "cuda"
device_map = "auto"
tokenizer, model, image_processor, max_length = load_pretrained_model(pretrained, None, model_name, torch_dtype="bfloat16", attn_implementation="eager", device_map=device_map)  # Add any other thing you want to pass in llava_model_args
model.eval()
...
with open("/fs01/home/adityac/projects/VAR/data/mcq_list_all_gpt_llavavideo7b.json", "r") as f:
...
for q in tqdm(mcq_list):
    ...
    with open('/fs01/home/adityac/projects/VAR/data/mcq_list_all_gpt_llavavideo7b.json', 'w') as f:
