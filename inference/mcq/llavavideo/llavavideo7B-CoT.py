...
with open("/h/adityac/projects/VAR/data/mcq_list_all_gpt_subset_t1.json", "r") as f:
    mcq_list = json.load(f)

with open("/h/adityac/projects/VAR/data/mcq_list_all_gpt_subset_t2.json", "r") as f:
    mcq_list2 = json.load(f)

mcq_list.extend(mcq_list2)
...
for q in tqdm(mcq_list):
    ...
    if curr_task == 1:
        ...
        question = f"Which of the following descriptions indicate what happened in the hidden (black) frames of the video? Provide your answer as \n'Reason: reason in 10 words.\nAnswer: your answer' \nA. {A}\nB. {B}\nC. {C}"
        ...
        #question = f"Which of these descriptions correctly explains what happens in this video? Provide an answer, followed by step-by-step reasoning for your answer choice. \nA. {A}\nB. {B}\nC. {C}" 
        question = f"Which of these descriptions correctly explains what happens in this video? Provide your answer as \n'Reason: reason in 10 words.\nAnswer: your answer'. \nA. {A}\nB. {B}\nC. {C}" 
    ...
    with open('/fs01/home/adityac/projects/VAR/results/mcq_list_all_gpt_llavavideo7B-CoT-v2.json', 'w') as f:
