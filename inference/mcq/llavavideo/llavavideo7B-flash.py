...
with open("/fs01/home/adityac/projects/VAR/data/mcq_list_all_gpt_llavavideo7B-Flash.json", "r") as f:
...
for q in tqdm(mcq_list):
    ...
    with open('/fs01/home/adityac/projects/VAR/data/mcq_list_all_gpt_llavavideo7B-Flash.json', 'w') as f:
