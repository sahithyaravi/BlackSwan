...
for q in tqdm(mcq_list):
    ...
    if curr_task == 1:
        ...
        question = f"The beginning of the video shows {pc_preevent}. The end of the video shows {pc_postevent}. Which of the following descriptions indicate what happened in the hidden (black) frames of the video? \nA. {A}\nB. {B}\nC. {C}"
    ...
    with open('/fs01/home/adityac/projects/VAR/results/mcq_list_all_gpt_llavavideo7B-Percep.json', 'w') as f:
