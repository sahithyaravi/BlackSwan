...
for q in tqdm(mcq_list):
    ...
    if "videochat2_predicted" in q:
        ans = eval_ans(q["mcq_label"], q["mcq_options"], q['videochat2_predicted'])
    ...
    if curr_task == 1:
        ...
        question = f"Select the description that indicates what happened in the hidden (black) frames of the video:\nA. {A}\nB. {B}\nC. {C}"
        ...
        question = f"Select the description that correctly explains what happens in this video:\nA. {A}\nB. {B}\nC. {C}"
        #question = f"Which of these descriptions correctly explains what happens in this video?\nA. {A}\nB. {B}\nC. {C}\nAnswer with the option's letter from the given choices directly. Answer:" 
    ...
    q["videochat2_predicted"] = out

    with open('/fs01/home/adityac/projects/VAR/data/mcq_list_all_gpt_videochat2.json', 'w') as f:
