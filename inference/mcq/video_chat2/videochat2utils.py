...
def eval_ans(label, options, out):
    ...
    if out.startswith('A') or out.startswith('(A) ') or out.startswith('A. ') or (options[0].lower() in out.lower()):
        if label == 0:
            answer = "correct"
        else:
            answer = "incorrect"
    ...
    elif out.startswith('B') or out.startswith('(B) ') or out.startswith('B. ') or (options[1].lower() in out.lower()):
        if label == 1:
            answer = "correct"
        else:
            answer = "incorrect"
        
    elif out.startswith('C') or out.startswith('(C) ') or out.startswith('C. ') or (options[2].lower() in out.lower()):
        if label == 2:
            answer = "correct"
        else:
            answer = "incorrect"
