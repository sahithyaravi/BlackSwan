...
for q in tqdm(mcq_list):
    ...
    if q['mcq_task'] == 1:
        ...
        completion = client.chat.completions.create(
            model="gpt-4o",
            messages=[
                {"role": "system", "content": "You will answer a Multiple Choice question. A question will include two video descriptions, one for the beginning and one for the end of the video. You will be asked to choose the correct answer based on the descriptions. You can only reply A, B, or C."},
                {
                    "role": "user",
